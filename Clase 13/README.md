![Powered-taller-R-orange](https://img.shields.io/badge/Powered_by-Taller_R-blue?logo=R) ![GitHub](https://img.shields.io/github/license/taller-R/clase_13) [![contributions welcome](https://img.shields.io/badge/contributions-welcome-brightgreen.svg?style=flat)](https://github.com/taller-R/clase_13/issues) ![](https://img.shields.io/github/followers/taller-R?style=social) 

<img src="https://avatars0.githubusercontent.com/u/69440432?s=400&u=96b3e58c713578b563d5c3d3c259f34965ac8e33&v=4" align="right" width=130 height=130 alt="" />
...
unzip(zipfile = "clase_13.zip")

# 4. Cambiar nuevamente el directorio de trabajo
setwd("~/Downloads/clase_13-master")
...
Después de descargar o clonar el repositorio de la clase, usted debe abrir el archivo **Intro-clase-13.html** que se encuentra dentro de la carpeta del repositorio. Siga atentamente las instrucciones.



## 3. Script de la clase

Ahora puedes ir a la carpeta **codes** y abrir el script **Clase 13.R** para replicar la clase.

![](help/figures/Yeah.gif)

## 4. Notas
* Los vídeos de la clase se encuentran [aquí](https://www.dropbox.com/sh/lolp0vve96ocxzi/AAAoJSJeotA7Lw01mHiUiF87a?dl=0). 
...
<a href="https://github.com/taller-R/clase_13/graphs/contributors">
<img src="https://contributors-img.web.app/image?repo=taller-R/clase_13"/>
</a>