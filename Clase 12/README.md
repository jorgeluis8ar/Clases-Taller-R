...
download.file(url = "https://github.com/taller-R/clase_12/archive/master.zip", 
              destfile = "clase_12.zip")

# 3. Descomprimir las carpeta
unzip(zipfile = "clase_12.zip")

# 4. Cambiar nuevamente el directorio de trabajo
setwd("~/Downloads/clase_12-master")
...
Ahora puedes ir a la carpeta **codes** y abrir el script **Clase 12.R** para replicar la clase.
...
<a href="https://github.com/taller-R/clase_12/graphs/contributors">
<img src="https://contributors-img.web.app/image?repo=taller-R/clase_12"/>
</a>