...
Cambiemos el directorio de trabajo por la ruta a la carpeta que contiene la ```Clase 7``` en nuestro equipo:
```{r}
...
* ```Clase 7``` (si lo descargas manualmente o creando una versión de control) 
* ```clase_7-master``` (si lo descargas usando la función ```download.file()```)
